    ...
    return Scaffold(
      ...
      (
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(image: AssetImage('images/top.jpeg'),
            fit: BoxFit.cover,
            )         
          ),
          child:
          Column(
            children:[
              ...
              SizedBox(height:20.0),
              Image(image: AssetImage('images/imgpro.png'),
                    ...
                    children:[
                      ...
                      style:TextStyle(
                       ...
                       Text(
                        ...
                        Center(
                          child: Image(image: AssetImage('images/signature.png'),
                          height:60.0),
                        ),
                        SizedBox(height:20.0),
                        Divider(
                        color: Colors.deepOrange,),
                        Text('Programming Languages Learnt',
                      textAlign: TextAlign.center,
                      style:TextStyle(
                        fontSize: 30.0,
                        fontWeight: FontWeight.bold
